...
from hete_syn_extraction import *
...
def get_srl_sentences(filepath, max_num=100000):
    """
...
def get_srl_data(config, train_data_path, dep_path, dev_data_path, vocab_path=None, label_path=None):
    # Load sentences (documents) from data paths respectively.
    raw_train_sents = get_srl_sentences(train_data_path, max_num=int(config.training_num))
    ...
    return (train_samples, dev_samples, dep_treebanks, eval_data,
            word_dict, head_dict, char_dict, label_dict, dep_label_dicts,
